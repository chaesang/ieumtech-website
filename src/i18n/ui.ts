...
export const ui = {
  ...
  ko: {
    ...
    'cta.linkedin': '링크드인',
    'cta.langToggle': 'EN',
    'footer.copy': '© 2026 이음테크. 모든 권리 보유.',
    'search.label': '검색',
    ...
    'contact.field.topic.advisory': '함께 일하기 (자문 · 코칭 · 트레이닝 · 프로젝트)',
    'contact.field.topic.talks': '강연·강의 (컨퍼런스 · 기업 · 학교 등)',
    'contact.field.topic.other': '그 밖의 인사 (글 감상 · 학생 질문 · 동료 안부 등)',
    ...
    'contact.success.signoff': '— 정채상, 이음테크',
